class AdminUserController < ApplicationController
  ...
  def fetch_complaints
    ...
    new_complaints = ComplaintStatus.where(status: "new")
    pending_complaints = ComplaintStatus.where(status: "pending")
    completed_complaints = ComplaintStatus.where(status: "completed")
    render json: {new_complaint: new_complaints, pending_complaint: pending_complaints, completed_complaint: completed_complaints}
  end
